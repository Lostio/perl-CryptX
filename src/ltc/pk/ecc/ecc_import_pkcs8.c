...
int _oid_to_id(const unsigned long *oid, unsigned long oid_size)
{
   int i, j;
...
int _pbes1_decrypt(const unsigned char *enc_data, unsigned long enc_size,
...
int _pbes2_pbkdf2_decrypt(const unsigned char *enc_data, unsigned long enc_size,
                          const unsigned char *pass,     unsigned long pass_size,
                          const unsigned char *salt,     unsigned long salt_size,
...
int _der_decode_pkcs8_flexi(const unsigned char *in,  unsigned long inlen,
